...
If you use the self-contained distribution, just download the archive and unpack it on your server.
...
- To setup email notification, fill out the configuration in <code>config/options.yml</code> and restart TinyCI.
