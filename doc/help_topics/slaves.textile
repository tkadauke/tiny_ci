...
You can specify capabilities and resources that a slave offers. Examples are "ruby", "rails", "gcc" or "8 gb ram", "3 cpus". A plan can only be built on this slave, if the slave fulfills all the the plans requirements.
