...
class SimpleCI::OutputParser::BaseTest < ActiveSupport::TestCase
  class TestParser < SimpleCI::OutputParser::Base
    def parse!
  ...
  test "should keep track of consumed output" do
    ...
    parser = SimpleCI::OutputParser::Base.new(output)
  ...
  test "should need a parse! method implemented" do
    assert_raise NotImplementedError do
      parser = SimpleCI::OutputParser::Base.new(stub)
      parser.parse!
    end
  end
end
